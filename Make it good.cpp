...
//    select either the first or the last element of b
//    remove it from b, and append it to the end of the array c
// For example, if we do 4 operations: take b1, then bm, then bm−1 and at last b2, then b becomes [b3,b4,…,bm−3] and c=[b1,bm,bm−1,b2]
// Consider the following example: b=[1,2,3,4,4,2,1]
// . This array is good because we can obtain non-decreasing array c from it by the following sequence of operations:

//     take the first element of b

// , so b=[2,3,4,4,2,1], c=[1]
// ;
// take the last element of b
// , so b=[2,3,4,4,2], c=[1,1]
// ;
// take the last element of b
// , so b=[2,3,4,4], c=[1,1,2]
// ;
// take the first element of b
// , so b=[3,4,4], c=[1,1,2,2]
// ;
// take the first element of b
// , so b=[4,4], c=[1,1,2,2,3]
// ;
// take the last element of b
// , so b=[4], c=[1,1,2,2,3,4]
// ;
// take the only element of b
// , so b=[], c=[1,1,2,2,3,4,4] — c is non-decreasing. 

// Note that the array consisting of one element is good.

// Print the length of the shortest prefix of a
// to delete (erase), to make a to be a good array. Note that the required length can be 0
